 ...
 */
final class Version20230927081949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carts_carts (id_value VARCHAR(255) NOT NULL, owner_id VARCHAR(255) DEFAULT NULL, coupon_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_C2A197877E3C61F9 (owner_id), INDEX IDX_C2A1978766C5951B (coupon_id), PRIMARY KEY(id_value)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE carts_carts_items (id_value VARCHAR(255) NOT NULL, cart_id VARCHAR(255) DEFAULT NULL, product_id INT DEFAULT NULL, quantity INT NOT NULL, features_value VARCHAR(255) DEFAULT NULL, INDEX IDX_6C49E6FF1AD5CDBF (cart_id), INDEX IDX_6C49E6FF4584665A (product_id), PRIMARY KEY(id_value)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
